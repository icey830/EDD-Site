<?php
/**
 * Template Name: Pricing (Alternate)
 *
			...
			<div class="license-info-content clearfix">
				...
				<div class="features-grid-content-sections flex-container">
					<div class="flex-two">
						...
						<p>License keys simply connect your site to ours, allowing us to send you automatic updates if your license is in good standing. We also provide extension support for valid license holders.</p>
					</div>
					<div class="flex-two">

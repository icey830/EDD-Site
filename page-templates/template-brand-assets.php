					...
					<section class="brand-assets">
						...
						<div id="logos">
							<div class="logo">
								...
								<p>
									Download <a href="<?php echo get_stylesheet_directory_uri() . '/brand-assets/logos/horizontal/logo-edd-dark.ai'; ?>" target="_blank">.ai</a>,
									<a href="<?php echo get_stylesheet_directory_uri() . '/brand-assets/logos/horizontal/logo-edd-dark.eps'; ?>" target="_blank">.eps</a>,
									<a href="<?php echo get_stylesheet_directory_uri() . '/brand-assets/logos/horizontal/logo-edd-dark.svg'; ?>" target="_blank">.svg</a>,
							...
							<div class="logo">
								...
								<p>
									Download <a href="<?php echo get_stylesheet_directory_uri() . '/brand-assets/logos/horizontal/logo-edd-light.ai'; ?>" target="_blank">.ai</a>,
									<a href="<?php echo get_stylesheet_directory_uri() . '/brand-assets/logos/horizontal/logo-edd-light.eps'; ?>" target="_blank">.eps</a>,
									<a href="<?php echo get_stylesheet_directory_uri() . '/brand-assets/logos/horizontal/logo-edd-light.svg'; ?>" target="_blank">.svg</a>,
							...
							<div class="logo">
								...
								<p>
									Download <a href="<?php echo get_stylesheet_directory_uri() . '/brand-assets/logos/vertical/logo-edd-dark.ai'; ?>" target="_blank">.ai</a>,
									<a href="<?php echo get_stylesheet_directory_uri() . '/brand-assets/logos/vertical/logo-edd-dark.eps'; ?>" target="_blank">.eps</a>,
									<a href="<?php echo get_stylesheet_directory_uri() . '/brand-assets/logos/vertical/logo-edd-dark.svg'; ?>" target="_blank">.svg</a>,
							...
							<div class="logo">
								...
								<p>
									Download <a href="<?php echo get_stylesheet_directory_uri() . '/brand-assets/logos/vertical/logo-edd-light.ai'; ?>" target="_blank">.ai</a>,
									<a href="<?php echo get_stylesheet_directory_uri() . '/brand-assets/logos/vertical/logo-edd-light.eps'; ?>" target="_blank">.eps</a>,
									<a href="<?php echo get_stylesheet_directory_uri() . '/brand-assets/logos/vertical/logo-edd-light.svg'; ?>" target="_blank">.svg</a>,

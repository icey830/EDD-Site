...
global $wp_query;
get_header();
$gateway_country_term = $wp_query->get_queried_object();
?>
		...
		<div class="inner">
			<div class="extensions-header clearfix">
				<div class="section-header">
					<h2 class="section-title">Gateway Country: <strong><?php echo $gateway_country_term->name; ?></strong></h2>
					<?php if ( ! empty( $gateway_country_term->description ) ) : ?>
						<p class="section-subtitle"><?php echo $gateway_country_term->description; ?></p>
					<?php endif; ?>

 ...
 */
function edd_page_menu_args( $args ) {
	$args['show_home'] = true;
	return $args;
}
add_filter( 'wp_page_menu_args', 'edd_page_menu_args' );

/**
 * Adds custom classes to the array of body classes.
 */
function edd_body_classes( $classes ) {
...
add_filter( 'body_class', 'edd_body_classes' );

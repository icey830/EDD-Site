			...
			<?php if ( ! is_page( 'checkout' ) || ! is_page( 130 ) || is_page( 635 ) ) : ?>
				<div class="columns clearfix">
					...
					<div class="consultants col">
						...
						<p>We maintain a list of consultants that we recommend working with when it comes to managed support, customization, and setup help. If you are looking for additional help with EDD, consider these <a href="<?php echo home_url( '/consultants/' ); ?>">trust consultants</a>.</p>
					</div><!-- /.consultants -->
				</div><!-- /.columns -->

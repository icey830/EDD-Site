...
define( 'EDD_SITE_VERSION', '2.4.2.2' );
...
function edd_register_theme_scripts() {
	...
	// 635 My Account
	if ( is_page( 635 ) || is_singular( 'download' ) || is_page_template( 'page-templates/template-download-directory.php' ) || is_page_template( 'page-templates/template-purchase-confirmation.php' ) || is_page_template( 'page-templates/template-affiliates-landing.php' ) || is_page_template( 'page-templates/template-all-access-downloads.php' ) ) {
